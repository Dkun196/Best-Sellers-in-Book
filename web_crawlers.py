...
urls = ['https://opentrolley.com.sg/Search.aspx?bestseller=bibles&page={}&pgsz=20'.format(i) for i in range(1,25)]
#
# From the list page
detail_url = []
name = []
...
# 
# In[4]
    output = open('/Users/yudiwang/Documents/19WinterECE 143/Group Project/opentrolley/Bible_Result200.csv', 
